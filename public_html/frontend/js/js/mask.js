...
$(document).ready(function() {
   ...
   $(".multiDateMask").mask("99/99/9999");
   $(".horaMask").mask("99:99");
   $(".cepMask").mask("99999-999");
   $(".cnpjMask").mask("99.999.999/9999-99");
   $(".foneMask").mask("(99) 9999-9999?9");
   $(".celMask").mask("(99) 9?9999-9999");
   $(".cpfMask").mask("999.999.999-99");
   $(".umNumeroMask").mask("9");
   $(".doisNumerosMask").mask("99");
   $(".tresNumerosMask").mask("999");
   $(".cestMask").mask("9999999");
   $(".oitoNumerosMask").mask("99999999");
   $(".dezNumerosMask").mask("9999999999");
   $(".quatorzeNumerosMask").mask("99999999999999");
   $(".creditCard").mask("9999 9999 9999 9999");
   $(".expirationDaate").mask("99/9999");
   $(".pisMask").mask("999.9999.999-9");
   $(".tempoMask").mask("99:99:99");
});