...
//         openMore.classList.add('displayNone')
//         op1.classList.remove('displayNone')
//         op2.classList.remove('displayNone')
//         op3.classList.remove('displayNone')
                ...
                case 'Efectivo':
                    ...
                    document.querySelector('.alertCash').classList.remove('displayNone')
                        ...
                        setTimeout(function(){
                            ...
                            document.querySelector('.alertP').classList.remove('hiddenOpacity');
                        },80)
